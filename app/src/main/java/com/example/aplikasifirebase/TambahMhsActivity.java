                ...
                if (nim.equals("") || nama.equals("") || jurusan.equals("") || angkatan.equals("")){
                    ...
                    myref.child(nim).setValue(mhs).addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            ...
                            Toast.makeText(TambahMhsActivity.this, "Data berhasil ditambahkan", Toast.LENGTH_LONG).show();
                            etNIM.setText("");
                            etNama.setText("");
                            etJurusan.setText("");
                            etAngkatan.setText("");
                        ...
                        public void onFailure(@NonNull Exception e) {
                            ...
                            Toast.makeText(TambahMhsActivity.this, "Data Gagal ditambahkan", Toast.LENGTH_LONG).show();
                        }
                    });
                }
            }
